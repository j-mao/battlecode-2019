...
public strictfp class MyRobot extends BCAbstractRobot {
	...
	private class BfsSolver {
		...
		private final Direction[] distanceFourMoves = {
			new Direction(-2, 0),
			new Direction(-1, -1),
			new Direction(-1, 0),
			new Direction(-1, 1),
		...
		private final Direction[] distanceNineMoves = {
			new Direction(-3, 0),
			new Direction(-2, -2),
			new Direction(-2, -1),
			new Direction(-2, 0),
		...
		void solve(MapLocation source, int maxSpeed,
			...
			if (maxSpeed == 4) possibleDirs = distanceFourMoves;
			else if (maxSpeed == 9) possibleDirs = distanceNineMoves;
			else {
